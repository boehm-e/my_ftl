...
**
** my_printf vous permet d'afficher une string sur la sortie standard.
**
...
**
** my_printf_color vous permet d'afficher une string sur la sortie standard de la couleur souhaitée.
...
void			my_printf_color(const char *color, const char *str)
{
  int			i;
